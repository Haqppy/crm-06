...
<body class="main">
 	...
 	<form:form id="role" action="${ctp}/role/saveAssign" method="post" modelAttribute="role">
		...
		<table class="query_form_table" border="0" cellPadding="3"
			...
			<tr>
				...
				<td class="input_content" colspan="5" valign="top">
					<c:forEach items="${pAuthorities }" var="pa">
						...
						&nbsp;&nbsp;&nbsp;
						<%-- 
						<c:forEach items="${pa.subAuthorities }" var="sub">
							${sub.displayName }
							<br><br>
						</c:forEach>
						--%>
