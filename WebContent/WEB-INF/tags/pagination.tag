...
<div style="text-align:right; padding:6px 6px 0 0;">
	...
	<% if (page.hasPreviousPage()){%>
		...
		&nbsp;&nbsp;
		<a href='?page=${page.number + 1-1}&${searchParams}'>上一页</a>
		&nbsp;&nbsp;
	<%}%>
	 
	<% if (page.hasNextPage()){%>
		<a href='?page=${page.number + 1+1}&${searchParams}'>下一页</a>
		&nbsp;&nbsp;
		<a href='?page=${page.totalPages}&${searchParams}'>末页</a>
		&nbsp;&nbsp;
	<%}%>
